...
- Fique no MESMO recurso da pergunta. Se ela é sobre o MCP, os relevantes são documentos de MCP — mesmo que cubram só parte (ex.: o passo a passo documentado é para o Claude e a pergunta é sobre o ChatGPT: o artigo do Claude é relevante e a cobertura é "parcial"). Nunca troque por documento de outro recurso só porque ele responde algo parecido (IA Ilimitada/OpenRouter ≠ MCP; Evolution ≠ WAHA; Supabase ≠ PostgreSQL da infra).
